#include <srl_rhcf_planner/stl_thetastar.h>
...
class Grid_planner{
    ...
    private:
        ...
        ros::Subscriber sub_all_agents_; ///< @brief subscriber to the people tracker

        ros::Publisher pub_discrete_path_; ///< @brief publisher of the dicrete path

        ros::Publisher pub_grid_; ///< @brief Publishing Grid

        ros::Publisher pub_graph_; ///< @brief Publishing graph
        ...
        int n_cellx_; ///< @brief Number of cells in the x axis;

        int n_celly_; ///< @brief Number of cells in the y axis;
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Initiliaze the RHCF object
        * @return true if no problem encountered
        */
        bool initializeRHCF();
        ...
        */
        ...
        /**
        * @brief Random Walk search over Voronoi Diagram
        * @param paths, the discrete path generated by A*
        * @param st, start node for the search
        * @return 1 if plan was found, 0 otherwise
        */
        int random_walk_search(std::vector<geometry_msgs::PoseStamped> &final_path);
       ...
       /**
        * @brief
        * @param p, path to be published
        * @return void
        */
        void publishGlobalPathPoses(std::vector<geometry_msgs::PoseStamped> p);


        /**
         * @brief Publish the navigation graph generated from the Voronoi
         * @param graph, vector of geometry_msgs to publish
         * @return void
         */
         void publishGraph(std::vector<geometry_msgs::Point>& graph);
        ...
        */
        ...
        /**
        * @brief Used to update the obstacles' information
        * @return Grid
        */
        void readCostMapCells();
        ...
        bool RHCFON_; /// TODO: insert into the param list

        std::vector<Thuman> agents_positions_; ///<  @brief agents

        int nagents_;

        int agents_reading_count_;

        bool wait_for_agents_;
