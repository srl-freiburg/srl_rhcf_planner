...
#include <srl_rhcf_planner/smp/common/region.h>
#include <srl_rhcf_planner/smp/components/model_checkers/base.h>
#include <srl_rhcf_planner/smp/components/cost_evaluators/base.h>
    ...
    */
    ...
    public:
        ...
        */
        ...
        double check_band (state_t *state_initial_in, trajectory_t *trajectory_in,
                                state_t *state_final_in = 0);
        ...
        double width_thetastar_tunnel_;
