...
#include <srl_rhcf_planner/smp/components/collision_checkers/collisionCostMap.h>
...
::initialize(base_local_planner::CostmapModel* world_model,std::vector<geometry_msgs::Point> footprint_spec, double inscribed_radius, double circumscribed_radius, costmap_2d::Costmap2DROS* costmap_ros, std::string planner_frame){
  ...
  CollCheckerlistener = new tf::TransformListener();
