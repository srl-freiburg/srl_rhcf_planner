...
#include <srl_rhcf_planner/smp/components/extenders/pos.h>

#include <srl_rhcf_planner/smp/components/extenders/state_array_double.hpp>
#include <srl_rhcf_planner/smp/components/extenders/input_array_double.hpp>
